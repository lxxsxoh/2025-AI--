...
def evaluate_model(model_path, test_data_root, classes, batch_size=64):
    ...
    cls0_idx = class_to_idx[classes[0]]
    cls1_idx = class_to_idx[classes[1]]
    ...
    print(f"  ▶ Class0 ({classes[0]}) Acc : {class0_acc:.4f}")
    print(f"  ▶ Class1 ({classes[1]}) Acc : {class1_acc:.4f}")
...
if __name__ == "__main__":
    ...
    for ratio_cls, model_path in best_models.items():
        evaluate_model(model_path, args.test_data_root, args.classes, args.batch_size)
